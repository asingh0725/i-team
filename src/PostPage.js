...
export function PostPage({ posts, userMap, comments }) {
  ...
  const [postComments, setPostComments] = useState(
    comments[postId] !== null ? comments[postId] : []
  );
  ...
  const handleCommentSubmit = async () => {
    if (comment.trim() !== "") {
      ...
      try {
        ...
        console.log("Comment added with Firestore ID: ", commentDocRef.id);
      } catch (error) {
  ...
  if (!post || !userDetails || !postComments) {
